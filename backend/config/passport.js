...
callbackURL: ((process.env.BACKEND_URL || 'http://localhost:5000').replace(/\/$/, '') + '/api/auth/microsoft/callback').replace('http://localhost:5000', process.env.NODE_ENV === 'production' ? 'https://university-event-club-management-system.onrender.com' : 'http://localhost:5000'),
      tenant: tenantId,
